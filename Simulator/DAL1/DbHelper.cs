...
namespace DAL1
{
    public class DbHelper
    {
        ...
        public static readonly String connectionString = @"Persist Security Info=False;Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=127.0.0.1) (PORT=1521)))(CONNECT_DATA=(SERVICE_NAME= orcl)));User Id=test3; Password=test3";
